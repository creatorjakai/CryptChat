...
def chat():
    ...
    pygame.draw.circle(screen, (150, 150, 150), (20, 20), 15)
    ...
    #Draw the chat menu buttons
    button_newchat = pygame.draw.circle(screen, (11, 185, 14), (328, 20), 15)
    screen.blit(asset_add, (319, 10))
    screen.blit(asset_chat, (10, 15))
    screen.blit(asset_call, (12, 53))
    screen.blit(asset_channel, (12, 92))
    screen.blit(asset_communitie, (11, 133))
    screen.blit(asset_media, (12, 656))
    screen.blit(asset_account, (12, 695))
    pygame.display.flip()
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            pygame.quit()
...
def calls():
    ...
    pygame.draw.circle(screen, (150, 150, 150), (20, 60), 15)
    button_channels = pygame.draw.circle(screen, (120, 120, 120), (20, 100), 15)
    button_communities = pygame.draw.circle(screen, (120, 120, 120), (20, 140), 15)
    button_media = pygame.draw.circle(screen, (120, 120, 120), (20, 665), 15)
    button_account = pygame.draw.circle(screen, (120, 120, 120), (20, 705), 15)
...
def channels():
    ...
    button_chat = pygame.draw.circle(screen, (120, 120, 120), (20, 20), 15)
    button_calls = pygame.draw.circle(screen, (120, 120, 120), (20, 60), 15)
    pygame.draw.circle(screen, (150, 150, 150), (20, 100), 15)
    button_communities = pygame.draw.circle(screen, (120, 120, 120), (20, 140), 15)
    button_media = pygame.draw.circle(screen, (120, 120, 120), (20, 665), 15)
    button_account = pygame.draw.circle(screen, (120, 120, 120), (20, 705), 15)
    pygame.draw.line(screen, (120, 120, 120), (43, 0), (43, 725), width=3)
    pygame.draw.line(screen, (120, 120, 120), (350, 0), (350, 725), width=3)
    #Draw the channels menu buttons
    screen.blit(asset_chat, (10, 15))
    screen.blit(asset_call, (12, 53))
    screen.blit(asset_channel, (12, 92))
    screen.blit(asset_communitie, (11, 133))
...
def communities():
    ...
    button_calls = pygame.draw.circle(screen, (120, 120, 120), (20, 60), 15)
    button_channels = pygame.draw.circle(screen, (120, 120, 120), (20, 100), 15)
    pygame.draw.circle(screen, (150, 150, 150), (20, 140), 15)
    button_media = pygame.draw.circle(screen, (120, 120, 120), (20, 665), 15)
    button_account = pygame.draw.circle(screen, (120, 120, 120), (20, 705), 15)
    pygame.draw.line(screen, (120, 120, 120), (43, 0), (43, 725), width=3)
    pygame.draw.line(screen, (120, 120, 120), (350, 0), (350, 725), width=3)
    #Draw the communities menu buttons
    screen.blit(asset_chat, (10, 15))
    screen.blit(asset_call, (12, 53))
    screen.blit(asset_channel, (12, 92))
    screen.blit(asset_communitie, (11, 133))
...
def media():
    ...
    button_channels = pygame.draw.circle(screen, (120, 120, 120), (20, 100), 15)
    button_communities = pygame.draw.circle(screen, (120, 120, 120), (20, 140), 15)
    pygame.draw.circle(screen, (150, 150, 150), (20, 665), 15)
    button_account = pygame.draw.circle(screen, (120, 120, 120), (20, 705), 15)
    pygame.draw.line(screen, (120, 120, 120), (43, 0), (43, 725), width=3)
    pygame.draw.line(screen, (120, 120, 120), (350, 0), (350, 725), width=3)
    #Draw the media menu buttons
    screen.blit(asset_chat, (10, 15))
    screen.blit(asset_call, (12, 53))
    screen.blit(asset_channel, (12, 92))
    screen.blit(asset_communitie, (11, 133))
...
def account():
    ...
    button_communities = pygame.draw.circle(screen, (120, 120, 120), (20, 140), 15)
    button_media = pygame.draw.circle(screen, (120, 120, 120), (20, 665), 15)
    pygame.draw.circle(screen, (150, 150, 150), (20, 705), 15)
    pygame.draw.line(screen, (120, 120, 120), (43, 0), (43, 725), width=3)
    pygame.draw.line(screen, (120, 120, 120), (350, 0), (350, 725), width=3)
    #Draw the account menu buttons
    screen.blit(asset_chat, (10, 15))
    screen.blit(asset_call, (12, 53))
    screen.blit(asset_channel, (12, 92))
    screen.blit(asset_communitie, (11, 133))
...
def load():
    ...
    global asset_account, asset_add, asset_call, asset_channel, asset_chat, asset_communitie, asset_media
    loadprc = 1
    pygame.init()
    pygame.display.init()
    pygame.font.init()
    ...
    asset_account = pygame.transform.scale(pygame.image.load("Assets/account.png"), (16, 16))
    asset_add = pygame.transform.scale(pygame.image.load("Assets/add.png"), (18, 18))
    asset_call = pygame.transform.scale(pygame.image.load("Assets/call.png"), (15, 15))
    asset_channel = pygame.transform.scale(pygame.image.load("Assets/channel.png"), (16, 16))
    asset_chat = pygame.transform.scale(pygame.image.load("Assets/chat.png"), (18, 12))
    asset_communitie = pygame.transform.scale(pygame.image.load("Assets/communitie.png"), (18, 12))
    asset_media = pygame.transform.scale(pygame.image.load("Assets/media.png"), (15, 15))
